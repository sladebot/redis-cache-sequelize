...
CacheStore.prototype = {
  ...
  generateKey: function (options) {
    ...
    if(options.action && options.id) {
      return (this.namespace + '::' + this.modelName.name.toString() + '::' + options.id + "::" + options.action);
    } else if(options.pattern && options.id) {
      return (this.namespace + '::' + this.modelName.name.toString() + '::' + options.id + "::" + options.pattern);
    } else if (options.id) {
  ...
  expirePattern: function(options) {
    ...
    var _key_pattern = this.generateKey(options);
    return new Promise(function promisify(resolve, reject) {
